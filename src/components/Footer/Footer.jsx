        ...
        <Row>
          <Col lg='4'>
            ...
            <p className='footer__text mt-4'>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem facere voluptatem blanditiis nostrum dolore accusamus aliquid. Asperiores ea voluptatem consectetur?
            </p>
          </Col>
          <Col lg='3'>
            ...
            <div className='footer__quick-links'>
              ...
              <ListGroup className='footer__contact mb-3'>
                ...
                <ListGroupItem className='ps-0 border-0 d-flex align-item-center gap-2'>
                  ...
                  <p>nguyenminhtuk52@gmail.com</p>
                </ListGroupItem>
              </ListGroup>
            </div>
          </Col>
          <Col lg='12'>
            <p className='footer__copyright'>Copyright {year} By Nguyen Minh Tu </p>
          </Col>
        </Row>
      </Container>
    </footer>
